...
public enum ElementsName {
   ...
   TAXEXEMPTIONREASONCODE(NamespacesName.CBC_NAMESPACE.label+"TaxExemptionReasonCode"),
   TAXEXEMPTIONREASON(NamespacesName.CBC_NAMESPACE.label+"TaxExemptionReason"),
   ...
   TAXCURRENCY_CODE(NamespacesName.CBC_NAMESPACE.label+"TaxCurrencyCode");
