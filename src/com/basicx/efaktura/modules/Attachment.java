...
import com.basicx.efaktura.attributes.PatternFile;
...
import com.basicx.efaktura.elements.EmbeddedDocumentBinaryObject;
...
public class Attachment {
     ...
     */
    public Element load() {
        Element elementAttachment = new ElementT(doc, ElementsName.ATTACHMENT.label).load();
