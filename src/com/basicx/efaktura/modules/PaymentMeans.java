...
import com.basicx.efaktura.elements.PaymentChannelCode;
import com.basicx.efaktura.elements.PaymentMeansCode;
import com.basicx.efaktura.elements.ID;
import com.basicx.efaktura.elements.PaymentDueDate;
...
public class PaymentMeans {
     ...
     */
    public Element load() {
        Element elementPaymentMeans1 = new ElementT(doc, ElementsName.PAYMENT_MEANS.label).load();
        if(!(id == null)){
