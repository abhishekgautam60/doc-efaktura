...
import com.basicx.efaktura.elements.CalculationSequenceNumeric;
    ...
    public Element load() {
        ...
        if(!(taxCategory == null)){
            Element elementTaxCategory = new TaxCategory.TaxCategoryBuilder()
                    ...
                    .taxExemptionReason(taxCategory.getTaxExemptionReason())
                    .taxExemptionReasonCode(taxCategory.getTaxExemptionReasonCode())
